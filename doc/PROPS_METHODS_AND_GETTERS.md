...
`lockScrollTimeout` | When `lockScrollWhileSnapping` activated, this prop determines the actual timeout before the scroll after snap is unlocked again. | Number | `1000`
