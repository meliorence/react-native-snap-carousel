...
export default class Carousel extends Component {
    ...
    static propTypes = {
        ...
        shouldRTLAdaptations: PropTypes.bool,
    ...
    _needsRTLAdaptations () {
        const { vertical, shouldRTLAdaptations } = this.props;
        return shouldRTLAdaptations && IS_RTL && !IS_IOS && !vertical;
    }
